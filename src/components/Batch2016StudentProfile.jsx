...
import { getBatch2016BySlug } from "../data/batch2016Students";
import { handleImgError } from "../utils/imageFallback";
import "./Alumni.css";

/**
 * Static 2016 batch student detail — same layout as other batch profiles.
 */
export default function Batch2016StudentProfile() {
  const { slug } = useParams();
  const student = slug ? getBatch2016BySlug(slug) : null;
  const [lightbox, setLightbox] = useState(null);

  if (!student) {
    return <Navigate to="/batch-2016-students" replace />;
  }
  ...
  return (
    <div className="alumni-profile-page">
      <div className="alumni-profile-inner">
        <Link to="/batch-2016-students" className="alumni-profile-back">
          ← 2016 batch students
        </Link>

        <article className="alumni-profile-card">
          <p className="alumni-profile-eyebrow">2016 batch</p>
