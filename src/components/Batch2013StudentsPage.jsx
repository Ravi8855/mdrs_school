          ...
          <div className="batch-page-gallery-extra">
            <div className="batch-page-gallery-extra__thumbs">
              <button
                ...
                onClick={() => setLightboxSrc("/gallery/m1.jpg")}
                aria-label="Open gallery image m1 larger"
              >
                <img src="/gallery/m1.jpg" alt="2013 batch gallery photo 1" decoding="async" onError={handleImgError} />
              </button>
              <button
                type="button"
                className="batch-page-gallery-extra__thumb"
                onClick={() => setLightboxSrc("/gallery/m2.jpg")}
